...
import { Plus, Search, Eye, CheckCircle, XCircle, MoreHorizontal, Phone, Mail } from 'lucide-react';
import { 
  DropdownMenu, 
  DropdownMenuContent, 
  DropdownMenuItem, 
...
export const AgentManagement = () => {
  ...
  const { viewMode, setViewMode } = useViewMode({ defaultView: 'list', storageKey: 'agents-management-view' });
