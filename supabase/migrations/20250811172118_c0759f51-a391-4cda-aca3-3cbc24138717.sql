-- Re-run with corrected table creation order to satisfy FKs
...
-- 3.2 users (must exist before permissions.created_by FK)
...
-- 3.3 permissions (now can reference users)
