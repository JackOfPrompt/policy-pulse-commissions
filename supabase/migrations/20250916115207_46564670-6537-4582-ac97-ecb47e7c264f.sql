...
-- Create partial unique index for active policy commissions
CREATE UNIQUE INDEX idx_policy_commissions_unique_active 
ON policy_commissions (policy_id) WHERE is_active = true;
