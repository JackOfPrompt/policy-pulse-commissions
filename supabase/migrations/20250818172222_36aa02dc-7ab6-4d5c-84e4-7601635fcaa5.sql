-- Run Remaining Migrations - Master Reference Data

-- Migrate master_departments → master_reference_data
INSERT INTO master_reference_data (category, code, name, parent_id, metadata, tenant_id, legacy_tenant_id, is_active, created_at, updated_at)
SELECT 
