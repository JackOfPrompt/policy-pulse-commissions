-- Create test users in auth.users table with proper IDs and test data
-- Note: These should match the profile IDs we created earlier

-- Insert test users into auth.users if they don't exist
-- This uses the handle_new_user function to create profiles automatically

-- First, let's create a proper test branch if it doesn't exist
...
-- Now create test profiles with valid kyc_status values
INSERT INTO public.profiles (id, email, full_name, user_type, employee_role, agent_type, is_active, kyc_status, phone) VALUES 
-- Admin user
('11111111-1111-1111-1111-111111111111', 'admin@test.com', 'Admin User', 'Admin', 'Admin', NULL, true, 'approved', '+91-9999999991'),
-- Employee users
('22222222-2222-2222-2222-222222222222', 'employee@test.com', 'Employee User', 'Employee', 'Sales', NULL, true, 'approved', '+91-9999999992'),
('33333333-3333-3333-3333-333333333333', 'manager@test.com', 'Branch Manager', 'Employee', 'Branch Manager', NULL, true, 'approved', '+91-9999999993'),
('44444444-4444-4444-4444-444444444444', 'ops@test.com', 'Operations Manager', 'Employee', 'Ops', NULL, true, 'approved', '+91-9999999994'),
('55555555-5555-5555-5555-555555555555', 'finance@test.com', 'Finance Manager', 'Employee', 'Finance', NULL, true, 'approved', '+91-9999999995'),
-- Agent users
('66666666-6666-6666-6666-666666666666', 'agent1@test.com', 'MISP Agent', 'Agent', NULL, 'MISP', true, 'approved', '+91-9999999996'),
('77777777-7777-7777-7777-777777777777', 'agent2@test.com', 'POSP Agent', 'Agent', NULL, 'POSP', true, 'approved', '+91-9999999997'),
-- Customer user
('88888888-8888-8888-8888-888888888888', 'customer@test.com', 'Customer User', 'Customer', NULL, NULL, true, 'approved', '+91-9999999998')
