-- Fix the enhanced commission calculation function to handle customer names correctly
...
BEGIN
  ...
  IF policy_rec.agent_id IS NOT NULL THEN
    -- Policy sourced by Agent (POSP/MISP)
  ...
  ELSE
    -- Policy sourced by Broker Org directly
