-- Enhanced policy status change trigger to create follow-up tasks
...
DROP TRIGGER IF EXISTS enhanced_policy_status_change ON public.policies_new;
CREATE TRIGGER enhanced_policy_status_change
  BEFORE UPDATE ON public.policies_new
  FOR EACH ROW
  EXECUTE FUNCTION public.enhanced_log_policy_status_change_with_tasks();