-- Fix security issues: Remove SECURITY DEFINER and add proper RLS
...
ALTER VIEW revenue_table SET (security_barrier = true);

-- Create RLS policy for the view
CREATE POLICY "Users can view revenue for their organization"
ON revenue_table
FOR SELECT
USING (org_id IN (
